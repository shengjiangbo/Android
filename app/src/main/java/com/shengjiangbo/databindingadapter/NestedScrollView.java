...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3,
    ...
    private void initScrollView() {
        mScroller = new CustomOverScroller(getContext());
        setFocusable(true);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    ...
                    if (overScrollByCompat(0, deltaY, 0, getScrollY(), 0, range, 0,
                            mOverScrollY, true) && !hasNestedScrollingParent(ViewCompat.TYPE_TOUCH)) {
    ...
    public void computeScroll() {
        ...
        if (unconsumed != 0) {
            // Internal Scroll
            final int oldScrollY = getScrollY();
            overScrollByCompat(0, unconsumed, getScrollX(), oldScrollY, 0, range, 0, mOverScrollY, false);
