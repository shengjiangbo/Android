...
public class CustomOverScroller {
     ...
     * @hide
     */
    public CustomOverScroller(Context context, Interpolator interpolator, boolean flywheel) {
     ...
     * @deprecated Use {@link #CustomOverScroller(Context, Interpolator)} instead.
     */
    @Deprecated
    public CustomOverScroller(Context context, Interpolator interpolator,
    ...
    static class SplineOverScroller {
        ...
        boolean springback(int start, int min, int max) {
            ...
            Log.d(TAG, "springback,mFinal : " + mFinal + " ; mStart : " + start);
            mVelocity = 0;
        ...
        private void startSpringback(int start, int end, int velocity) {
            ...
            Log.d(TAG, "startSpringback,mStart : " + mStart + " ; mFinal : " + mFinal);
        }
        ...
        private void fitOnBounceCurve(int start, int end, int velocity) {
            ...
            Log.d("CustomOverScroller", "mDeceleration : " + mDeceleration + " ; mStartTime : " + mStartTime + " ; mCurrentPosition : " + mCurrentPosition + " ; mVelocity : " + mVelocity);
        }
        ...
        private void onEdgeReached() {
            ...
            Log.d(TAG, "onEdgeReached, mOver : " + mOver + " ; mFinal : " + mFinal);
        }
            ...
            switch (mState) {
                ...
                case BALLISTIC:
                    ...
                    if (mMin != Integer.MIN_VALUE && mMax != Integer.MIN_VALUE) {
                        if (mStart < mMin && mFinal > mMin - mFlingOriginalOver) {
                            Log.d(TAG, "change start,mStart : " + mStart + " ; mMin : " + mMin + " ; mFinal : " + mFinal + " ; mFlingOriginalOver : " + mFlingOriginalOver);
                            mStart = mMin;
                        } else if (mStart > mMax && mFinal < mMax + mFlingOriginalOver) {
                            Log.d(TAG, "change start,mStart : " + mStart + " ; mMax : " + mMax + " ; mFinal : " + mFinal + " ; mFlingOriginalOver : " + mFlingOriginalOver);
                            mStart = mMax;
                        }
                    }
        ...
        boolean update() {
            ...
            Log.d(TAG, "update, mStart : " + mStart + " ; distance : " + distance + " ; mCurrentPosition : " + mCurrentPosition);
